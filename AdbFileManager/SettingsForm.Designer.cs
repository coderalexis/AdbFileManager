namespace AdbFileManager {
	partial class SettingsForm {
        ...
        private void InitializeComponent() {
            ...
            label3 = new Label();
            checkBox_rememberLocation = new CheckBox();
            checkBox_compatibilityMode = new CheckBox();
            checkBox_unwrapFolderLegacy = new CheckBox();
            checkBox_previewMediaFiles = new CheckBox();
            checkBox_keepFileModificationDate = new CheckBox();
            checkBox_fastCompatibility = new CheckBox();
            ...
            tab_behaviour.Controls.Add(checkBox_rememberLocation);
            tab_behaviour.Controls.Add(checkBox_compatibilityMode);
            tab_behaviour.Controls.Add(checkBox_unwrapFolderLegacy);
            tab_behaviour.Controls.Add(checkBox_previewMediaFiles);
            tab_behaviour.Controls.Add(checkBox_keepFileModificationDate);
            tab_behaviour.Controls.Add(checkBox_fastCompatibility);
            ...
            // 
            // checkBox_rememberLocation
            // 
            checkBox_rememberLocation.AutoSize = true;
            checkBox_rememberLocation.Location = new Point(267, 56);
            checkBox_rememberLocation.Name = "checkBox_rememberLocation";
            checkBox_rememberLocation.Size = new Size(135, 19);
            ...
            // 
            checkBox_compatibilityMode.AutoSize = true;
            checkBox_compatibilityMode.Location = new Point(267, 6);
            checkBox_compatibilityMode.Name = "checkBox_compatibilityMode";
            checkBox_compatibilityMode.Size = new Size(114, 19);
            checkBox_compatibilityMode.TabIndex = 3;
            checkBox_compatibilityMode.Text = "Compatibility fix";
            checkBox_compatibilityMode.UseVisualStyleBackColor = true;
            checkBox_compatibilityMode.CheckedChanged += checkBox_compatibilityMode_CheckedChanged;
            // 
            ...
            // 
            // checkBox_previewMediaFiles
            // 
            checkBox_previewMediaFiles.AutoSize = true;
            checkBox_previewMediaFiles.Location = new Point(9, 31);
            checkBox_previewMediaFiles.Name = "checkBox_previewMediaFiles";
            checkBox_previewMediaFiles.Size = new Size(211, 19);
            checkBox_previewMediaFiles.TabIndex = 1;
            checkBox_previewMediaFiles.Text = "Preview media files on double click";
            checkBox_previewMediaFiles.UseVisualStyleBackColor = true;
            checkBox_previewMediaFiles.CheckedChanged += checkBox_previewMediaFiles_CheckedChanged;
            // 
            // checkBox_keepFileModificationDate
            // 
            checkBox_keepFileModificationDate.AutoSize = true;
            checkBox_keepFileModificationDate.Location = new Point(9, 6);
            checkBox_keepFileModificationDate.Name = "checkBox_keepFileModificationDate";
            checkBox_keepFileModificationDate.Size = new Size(168, 19);
            checkBox_keepFileModificationDate.TabIndex = 0;
            checkBox_keepFileModificationDate.Text = "Keep file modification date";
            checkBox_keepFileModificationDate.UseVisualStyleBackColor = true;
            checkBox_keepFileModificationDate.CheckedChanged += checkBox_keepFileModificationDate_CheckedChanged;
            // 
            // checkBox_fastCompatibility
            // 
            checkBox_fastCompatibility.AutoSize = true;
            checkBox_fastCompatibility.Location = new Point(279, 31);
            checkBox_fastCompatibility.Name = "checkBox_fastCompatibility";
            checkBox_fastCompatibility.Size = new Size(154, 19);
		...
		private CheckBox checkBox_keepFileModificationDate;
		private CheckBox checkBox_rememberLocation;
		private CheckBox checkBox_fastCompatibility;
		private CheckBox checkBox_compatibilityMode;
		private CheckBox checkBox_unwrapFolderLegacy;
		private CheckBox checkBox_previewMediaFiles;
